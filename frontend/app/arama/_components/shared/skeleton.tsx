...
export function SkeletonCard({ delay = 0 }: { delay?: number }) {
  return (
    <motion.div
      ...
      className="bg-[#111113] border border-white/[0.06] rounded-2xl p-5 space-y-3.5"
    >
      <div className="flex items-center gap-2.5">
        <ShimmerBlock className="h-[24px] w-24 rounded-md" />
        <ShimmerBlock className="h-[18px] w-32" />
      </div>
      <div className="flex items-center gap-3">
        <ShimmerBlock className="h-[16px] w-28" />
        <ShimmerBlock className="h-[16px] w-28" />
        <ShimmerBlock className="h-[16px] w-20 ml-auto" />
      </div>
      <div className="space-y-2.5">
        <ShimmerBlock className="h-[16px] w-full" />
        <ShimmerBlock className="h-[16px] w-[90%]" />
...
export function SkeletonDetail() {
  return (
    <div className="space-y-5 animate-fade-in">
      ...
      <div className="bg-[#111113] border border-white/[0.06] rounded-2xl p-6 space-y-3">
        <ShimmerBlock className="h-5 w-20" />
