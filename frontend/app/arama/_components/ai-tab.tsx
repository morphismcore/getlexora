    ...
    <div className="flex-1 flex flex-col min-h-0">
      ...
      <div className="shrink-0 px-4 md:px-6 py-3 border-b border-white/[0.06] flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-[14px] font-semibold text-[#ECECEE]">
              AI Hukuk Asistanı
            </h3>
              ...
              {msg.role === "assistant" &&
                ...
                msg.sources.length > 0 && (
                  <div className="mt-3 pt-3 border-t border-white/[0.06]">
                    <p className="text-[11px] font-semibold text-[#5C5C5F] uppercase tracking-wider mb-2">
                      Kaynaklar
                    </p>
                    <div className="space-y-1.5">
                      {msg.sources.map((s, si) => {
                        ...
                        return (
                          ...
                          >
                            <span
                              className={`inline-flex items-center px-1.5 py-0.5 rounded text-[9px] font-semibold ${court.bg} ${court.text}`}
                            >
                            ...
                            {s.tarih && (
                              <span className="text-[10px] text-[#5C5C5F] ml-auto shrink-0">
                                {s.tarih}
                              </span>
                            )}
                          </button>
                ...
                msg.warnings.length > 0 && (
                  <div className="mt-2 space-y-1">
                    {msg.warnings.map((w, wi) => (
                      <p
                        key={wi}
                        className="text-[11px] text-[#FFB224]/80 flex items-start gap-1.5"
                      >
                        <svg
