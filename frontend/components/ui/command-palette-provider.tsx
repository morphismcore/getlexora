  ...
  const groups = [
    {
      ...
      items: [
        ...
        { id: "istatistik", label: "İstatistik", icon: bookIcon, shortcut: "Ctrl+5", onSelect: () => router.push("/istatistik") },
        { id: "dilekce", label: "Dilekçe Oluştur", icon: bookIcon, shortcut: "Ctrl+6", onSelect: () => router.push("/dilekce") },
        { id: "belge", label: "Belge Analiz", icon: searchIcon, shortcut: "Ctrl+7", onSelect: () => router.push("/belge") },
        { id: "davalar", label: "Dava Dosyaları", icon: homeIcon, shortcut: "Ctrl+8", onSelect: () => router.push("/davalar") },
      ],
    },
    {
      ...
      items: [
        ...
        { id: "sure-hesapla", label: "Süre Hesapla (Dava Detayında)", icon: shieldIcon, onSelect: () => router.push("/davalar") },
      ],
    },
  ];
